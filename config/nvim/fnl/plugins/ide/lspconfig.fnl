...
(fn M.config []
  ...
  (fn lsp-on-attach [ev]
    ...
    (let [lsp vim.lsp.buf]
      ...
      (nmapp! :ld (cmd! "Telescope lsp_definitions") :Definitions ev.buf)
      ...
      (nmapp! :wa lsp.add_workspace_folder "Workspace Add Folder" ev.buf)
      (nmapp! :wr lsp.remove_workspace_folder "Workspace Remove Folder" ev.buf)
      (nmapp! :wl #(print (vim.inspect (lsp.list_workspace_folders)))
